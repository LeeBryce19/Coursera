...
```{r}
ggplot(NYPD_data,mapping = aes(x = boro))+geom_bar(aes(fill = boro))+labs(title = "NYPD Shooting Incident Based On Borough")+theme_bw()
...
```{r}
ggplot(NYPD,mapping= aes(x= statistical_murder_flag ))+ geom_bar(aes(fill = statistical_murder_flag))+ labs(title = "NYPD Statistical Murder")+theme_bw()
...
ggplot(NYPD_data,mapping= aes(y= vic_race ))+ geom_bar(aes(fill = vic_race))+ labs(title = "COUNT OF INCIDENT BASED ON VICTIM'S RACE")+theme_bw()
...
ggplot(NYPD_data,mapping= aes(y= perp_race ))+ geom_bar(aes(fill = perp_race))+ labs(title = "COUNT OF INCIDENT BASED ON PREP'S RACE")+theme_bw()
